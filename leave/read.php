            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-8 pull-right">
                        <h2>Leave ID : <?php echo $item_array["leaveID"] . " " . $item_array["leaveDaysAmt"]; ?></h2>
                        <p class="form-control-static h4">Leave Description : <?php echo $item_array["leaveDescription"]; ?></p>
                    ...
                    <div class="col-md-12"> 
                        ...
                        <p><a href="update.php" class="btn btn-primary btn-lg btn-block">Update Record</a></p>
                     </div>
                </div>
            </div>        
        </div>
